...
export default function Paragraph3() {
  ...
  const sellNftDetails = [
    ...
    },
    {
      ...
      description:
        "Once you set up wallet of choice, connect it to MetaAir Marketplace by clicking the wallet icon in the top right corner. Learn about the wallets we support",
    },
    {
      iconUrl: "/assets/svg/sell-nft-icon4",
      title: "List Items For Sale",
      description:
        "Sell your items with price and also have ability to cancel anytime from sale and edit price can work at bnb net, any network with solidity",
    },
  ];
